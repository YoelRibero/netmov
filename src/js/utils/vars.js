// Base url Movies
export const BASE_API_MOVIES = 'https://yts.mx/api/v2'
export const API_KEY = '31ac442542ef5e103116c8e516f1661b'
// Selectors Movies
export const $featuringContainer = document.querySelector('#featuring')
export const $featuringTitle = document.querySelector('.featuring__title')
export const $actionContainer = document.querySelector('#action')
...
export const navbarItemHome = document.querySelector('[data-nav="home"]')
// Login Form
export const mainUser = document.querySelector('#main-user')
export const loginContainer = document.querySelector('.login')
export const loginForm = document.querySelector('.login form')
export const userNameInput = loginForm.querySelector('#user-name')
export const userSocialInput = loginForm.querySelector('#user-social')
